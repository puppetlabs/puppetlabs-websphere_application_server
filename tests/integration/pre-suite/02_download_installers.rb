...
test_name 'FM-3804 - Cxxx - Apply DSC Resource Manifest via "puppet agent" with Debug Enabled'
...
on(master, puppet('module install dsestero-download_uncompress'))
