...
* [`websphere_jdbc_datasource_custom_property`](#websphere_jdbc_datasource_custom_property): This manages WebSphere JDBC datasource custom properties.
* [`websphere_jdbc_datasource_jaas_auth_data`](#websphere_jdbc_datasource_jaas_auth_data): This manages WebSphere JDBC JAAS Auth Data. Also known as auth aliases.
...
* [`websphere_jvm_custom_property`](#websphere_jvm_custom_property): This manages WebSphere jvm custom properties.
* [`websphere_jvm_log`](#websphere_jvm_log): This manages a WebSphere JVM Logging Properties'
* [`websphere_namespace_binding`](#websphere_namespace_binding): This manages WebSphere namespace bindings.
...
* [`websphere_security_custom_property`](#websphere_security_custom_property): This manages a WebSphere Global Security Custom Property'
* [`websphere_shared_library`](#websphere_shared_library): This manages WebSphere Shared libraries.
...
* [`websphere_application_server::create_repo`](#websphere_application_servercreate_repo)
* [`websphere_application_server::pe_server_setup`](#websphere_application_serverpe_server_setup)
* [`websphere_application_server::provision_machines`](#websphere_application_serverprovision_machines)
* [`websphere_application_server::puppet_agents_setup`](#websphere_application_serverpuppet_agents_setup)
...
The specific backend to use for this `websphere_app_server` resource. You will seldom need to specify this --- Puppet
...
The specific backend to use for this `websphere_cluster` resource. You will seldom need to specify this --- Puppet will
...
The specific backend to use for this `websphere_cluster_member` resource. You will seldom need to specify this ---
...
The specific backend to use for this `websphere_cluster_member_service` resource. You will seldom need to specify this
--- Puppet will usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_federate` resource. You will seldom need to specify this --- Puppet will
usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_jdbc_datasource` resource. You will seldom need to specify this ---
Puppet will usually discover the appropriate provider for your platform.
...
The following properties are available in the `websphere_jdbc_datasource_custom_property` type.
...
The following parameters are available in the `websphere_jdbc_datasource_custom_property` type.
...
The specific backend to use for this `websphere_jdbc_datasource_custom_property` resource. You will seldom need to
...
The following properties are available in the `websphere_jdbc_datasource_jaas_auth_data` type.
...
The following parameters are available in the `websphere_jdbc_datasource_jaas_auth_data` type.
...
The specific backend to use for this `websphere_jdbc_datasource_jaas_auth_data` resource. You will seldom need to
specify this --- Puppet will usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_jdbc_provider` resource. You will seldom need to specify this --- Puppet
will usually discover the appropriate provider for your platform.
...
The following properties are available in the `websphere_jvm_custom_property` type.
...
The following parameters are available in the `websphere_jvm_custom_property` type.
...
The specific backend to use for this `websphere_jvm_custom_property` resource. You will seldom need to specify this ---
Puppet will usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_jvm_log` resource. You will seldom need to specify this --- Puppet will
usually discover the appropriate provider for your platform.
...
The following properties are available in the `websphere_namespace_binding` type.
...
The following parameters are available in the `websphere_namespace_binding` type.
...
The specific backend to use for this `websphere_namespace_binding` resource. You will seldom need to specify this ---
Puppet will usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_node` resource. You will seldom need to specify this --- Puppet will
usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_sdk` resource. You will seldom need to specify this --- Puppet will
usually discover the appropriate provider for your platform.
...
The following properties are available in the `websphere_security_custom_property` type.
...
The following parameters are available in the `websphere_security_custom_property` type.
...
The specific backend to use for this `websphere_security_custom_property` resource. You will seldom need to specify this
--- Puppet will usually discover the appropriate provider for your platform.
...
The following properties are available in the `websphere_shared_library` type.
...
The following parameters are available in the `websphere_shared_library` type.
...
The specific backend to use for this `websphere_shared_library` resource. You will seldom need to specify this ---
Puppet will usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_variable` resource. You will seldom need to specify this --- Puppet will
usually discover the appropriate provider for your platform.
...
The specific backend to use for this `websphere_web_server` resource. You will seldom need to specify this --- Puppet
will usually discover the appropriate provider for your platform.
...
The websphere_application_server::create_repo class.

#### Parameters

The following parameters are available in the `websphere_application_server::create_repo` plan.
...
Default value: `'http://www.ibm.com/software/repositorymanager/com.ibm.websphere.NDTRIAL.v85'`
...
Default value: `'com.ibm.websphere.NDTRIAL.v85_8.5.5016.20190801_0951'`
...
Default value: `'/var/ibm/ibm_packages'`
...
Default value: `'~/master_password_file.txt'`
...
Default value: `'/opt/ibm_pu_installer'`

##### `remote_ibm_pu_zipfile`

Data type: `Optional[String[1]]`



Default value: `'ibm_pu.zip'`

##### `remote_unzipped_location`

Data type: `Optional[String[1]]`



Default value: `"${remote_install_dir}/disk_linux.gtk.x86_64/InstallerImage_linux.gtk.x86_64/"`
...
Default value: `"${remote_unzipped_location}/installc -acceptLicense"`
...
Default value: `'/opt/IBM/InstallationManager'`
...
Default value: `"${im_basedir}/eclipse/tools/imutilsc"`
...
Default value: `'/opt/IBM/PackagingUtility/PUCL'`

### `websphere_application_server::pe_server_setup`

The websphere_application_server::pe_server_setup class.

### `websphere_application_server::provision_machines`

The websphere_application_server::provision_machines class.
...
The websphere_application_server::puppet_agents_setup class.
